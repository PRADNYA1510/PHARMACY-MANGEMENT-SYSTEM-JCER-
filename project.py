...
class login_window:
    def __init__(self,root):
        ...
        username=Label(frame,font=("",12,"bold"),text="Username",fg="black",bg="white")
        username.place(x=70,y=140)

        self.username_entry=ttk.Entry(frame,font=("arial",12,""))
        self.username_entry.place(x=40,y=170,width=250)

        passward=Label(frame,font=("arial",12,"bold"),text="Password",fg="black",bg="white")
        passward.place(x=70,y=210)

        self.passward_entry=ttk.Entry(frame,font=("",12,""),show="*")
        ...
        #===================login button===============
        login=Button(frame,text="LOGIN",command=self.login,bg="Yellow",fg="Black",font=("arial",10,"bold"),width=12,relief=RIDGE,activeforeground="white",activebackground="red")
        login.place(x=100,y=310,width=120,height=30)
                

        register=Button(frame,text=" New Register",bg="white",command=self.register_window,fg="black",font=("arial",10,"bold"),width=12,border=0,activeforeground="black",activebackground="white")
        register.place(x=3,y=350,width=120)
                        
        forgot=Button(frame,text="Forgot Password..?",command=self.forgot_pass,bg="white",fg="black",font=("arial",10,"bold"),width=12,border=0,activeforeground="black",activebackground="white")
    ...
    def reset_pass(self):
        if self.sec_combo.get()== "select":
            ...
            values=(self.username_entry.get(),self.sec_combo.get(),self.semail_entry.get())
...
class Register:
    def __init__(self,root):
        ...
        #dataframe.place(x=0,y=100,width=1260,height=500)
        
        
        
        
        #=================main frame===================
        frame=Frame(self.root,bg="#92a8d1")
        frame.place(x=500,y=120,width=720,height=450)

        Register=Label(frame,font=("times new roman",25,"bold"),text="REGISTER HERE",fg="red",bg="#92a8d1")
        Register.place(x=20,y=20)
        
        #===============label and entry==============
        #1
        fname=Label(frame,font=("times new roman",15,""),text="First Name",fg="black",bg="#92a8d1")
        ...
        Lname=Label(frame,font=("times new roman",15,""),text="Last Name",fg="black",bg="#92a8d1")
        ...
        contactno=Label(frame,font=("times new roman",15,""),text="Contact No",fg="black",bg="#92a8d1")
        ...
        email=Label(frame,font=("times new roman",15,""),text="Email Id",fg="black",bg="#92a8d1")
        ...
        security=Label(frame,font=("times new roman",15,""),text="Security Question",fg="black",bg="#92a8d1")
        ...
        passward=Label(frame,font=("times new roman",15,""),text="Password",fg="black",bg="#92a8d1")
        ...
        confirm_passward=Label(frame,font=("times new roman",15,""),text="Confirm Password",fg="black",bg="#92a8d1")
        ...
        checkbtn=Checkbutton(frame,text="I agree to terms & condition",variable=self.var_check,font=("arial",10,""),bg="#92a8d1",onvalue=1,offvalue=0)
        ...
        secans=Label(frame,font=("times new roman",15,""),text="Security Answer",fg="black",bg="#92a8d1")
...
class PharmacyManagementSystem:
    def __init__(self, root):
        ...
        lbluser=Label(DataframeLeft,font=("arial",12,"bold"),text="Disease:",padx=2,pady=6)
        ...
        lblsdf=Label(DataframeLeft,font=("arial",12,"bold"),text="Side effects:",padx=2,pady=6)
        ...
        lblPW=Label(DataframeLeft,font=("arial",12,"bold"),text="Warning:",padx=2,pady=6)
        ...
        lblproduct=Label(DataframeLeft,font=("arial",12,"bold"),text="Product Quantity:",padx=2,pady=6)
        ...
        lblrefno=Label(DataframeRight,font=("arial",12,"bold"),text="Ref no",padx=15,pady=6)
        ...
        self.Pharmacy_table.heading("Ref",text="Ref no",)
        ...
        self.Pharmacy_table.heading("uses",text="Disease")
    ...
    def AddMed(self):
        ...
        messagebox.showinfo("successfully", "medicine added from department",parent=self.root)  
        self.get_cursor()
        conn.close()
